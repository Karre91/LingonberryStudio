...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LingonberryStudio.Data.Entities.DatesAndTimes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LingonberryStudio.Data.Entities.Days", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LingonberryStudio.Data.Entities.Facilities", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LingonberryStudio.Data.Entities.Measurements", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LingonberryStudio.Data.Entities.Advert", b =>
                {
                    b.HasOne("LingonberryStudio.Data.Entities.DatesAndTimes", "Avaliability")
                        .WithMany()
                        .HasForeignKey("AvaliabilityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LingonberryStudio.Data.Entities.Facilities", "Facilities")
                        .WithMany()
                        .HasForeignKey("FacilitiesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LingonberryStudio.Data.Entities.Measurements", "Measurements")
                        .WithMany()
            ...
            modelBuilder.Entity("LingonberryStudio.Data.Entities.DatesAndTimes", b =>
                {
                    b.HasOne("LingonberryStudio.Data.Entities.Days", "WeekDays")
                        .WithMany()
